...
### 1. Zepto
- This project analyzes a quick-commerce dataset inspired by Zepto to uncover insights related to pricing, demand, and inventory management. The goal is to identify business problems such as stockouts, inefficient discounting, and skewed demand, and provide data-driven recommendations..
- **📁 [View Project Details](./01_Zepto-analysis)**
